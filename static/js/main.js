...
<input type="text" id="classIdUpload"><br><br>
...
        <form id="classForm">
            <label>Class ID:</label>
            <input type="text" id="classIdPerformance"><br><br>
            <button type="button" onclick="submitClassPerformance()">Submit</button>
        </form>
...
            <input type="text" id="regNoLookup" required><br><br>
            <button type="button" onclick="submitStudentPerformance()">View Report</button>
        </form>
        <div id="result" style="margin-top: 20px;">
...
            resultDiv.insertAdjacentHTML('beforeend', '<h5 class="w3-margin-top w3-border-bottom w3-padding-small">Subject-Wise Performance (ML Prediction Count)</h5>');
            
            // Create a container for the individual charts, showing two charts per row (w3-half)
            let chartsHTML = '<div id="individualChartsContainer" class="w3-row-padding">'; 
            subjectNames.forEach((subjectName) => {
                chartsHTML += `
                    <div class="w3-half w3-margin-bottom">
                        <div class="w3-card w3-padding">
                            <h6>${subjectName} Performance Levels</h6>
...
    let tableHTML = `
        <h5 class="w3-border-bottom w3-padding-small">Overall Student Performance</h5>
        <table class="table table-striped w3-table-all w3-hoverable">
            <thead>
                <tr class="w3-light-grey">
                    <th>REGISTER NO</th>
                    <th>STUDENT NAME</th>
